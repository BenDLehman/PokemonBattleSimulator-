...
/**
 * MoveThree.java -Flexible command that is compatible for future customization which will perform
 * the move within the Pokemon's third moveslot.
 * @author Benjamin Hurston
 */
public class MoveThree implements Command
{
	trainer trainer1;
	trainer trainer2;
	trainer active;
	...
	public MoveThree(trainer trainer1, trainer trainer2)
	{
	...
	/**
	 * Execute the third move of the attacking Pokemon. Damage is calculated as the following algorithm:
