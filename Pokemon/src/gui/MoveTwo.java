...
/**
 * MoveTwo.java -Flexible command that is compatible for future customization which will perform
 * the move within the Pokemon's second moveslot.
 * @author Benjamin Hurston
 */
public class MoveTwo implements Command
{
	trainer trainer1;
	trainer trainer2;
	trainer active;
	...
	public MoveTwo(trainer trainer1, trainer trainer2)
	{
	...
	/**
	 * Execute the second move of the attacking Pokemon. Damage is calculated as the following algorithm:
