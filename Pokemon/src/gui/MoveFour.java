...
/**
 * MoveFour.java -Flexible command that is compatible for future customization which will perform
 * the move within the Pokemon's fourth moveslot.
 * @author Benjamin Hurston
 */
public class MoveFour implements Command
{
	private trainer trainer1;
	private trainer trainer2;
	private trainer active;
	private trainer inactive;
	...
	/**
	 * Build the MoveFour command.
	 * @param trainer1	the first trainer.
	 * @param trainer2	the second trainer.
	 */
	public MoveFour(trainer trainer1, trainer trainer2)
	{
	...
	/**
	 * Execute the fourth move of the attacking Pokemon. Damage is calculated as the following algorithm:
